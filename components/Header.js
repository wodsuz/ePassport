      ...
      <header className="sticky inset-x-0 top-0 z-10 h-20 min-w-full text-white border-b border-purple-900 bg-primary backdrop-filter backdrop-blur-lg bg-opacity-30">
        <div className="container flex items-center justify-between h-full mx-auto max-w-7xl">
          ...
          <Link href="/" passHref={true}>
            <span className="pr-2 text-transparent bg-clip-text bg-gradient-to-br from-pink-400 to-sky-100">
              ePassport
            </span>
          </Link>
          ...
          <nav aria-label="Main Menu">
            <ul className="flex items-center space-x-8">
              ...
              <li className="px-4 py-2 font-extrabold text-purple-300 border border-purple-300 rounded-md cursor-pointer hover:text-purple-500 hover:border-purple-500">
                <a
                  className=""
                  id="walletButton"
          ...
          <nav aria-label="Contact Menu">
            <ul className="flex items-center space-x-6">
              ...
              <li>
                <a
                  href="https://discord.gg/TTC7kaMH"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
